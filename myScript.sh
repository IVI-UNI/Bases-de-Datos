...
mysql -e "DROP USER IF EXISTS 'administrador'@'localhost'"
mysql -e "CREATE USER 'administrador'@'localhost' IDENTIFIED BY '${PASSWDDB}';"
mysql -e "GRANT ALL PRIVILEGES ON * . * TO 'administrador'@'localhost'"
...
MYSQL_PWD=${PASSWDDB} mysql -u administrador -D resultadosofertaacademica -e "CREATE TABLE NotasCorte2020(CURSO_ACADEMICO INT, ESTUDIO VARCHAR(100), LOCALIDAD VARCHAR(30), CENTRO VARCHAR(100), PRELA_CONVO_NOTA_DEF CHAR(2), NOTA_CORTE_DEFINITIVA_JULIO  FLOAT, NOTA_CORTE_DEFINITIVA_SEPTIEMBRE VARCHAR(30), FECHA_ACTUALIZACION VARCHAR(15));"
MYSQL_PWD=${PASSWDDB} mysql -u administrador -D resultadosofertaacademica -e "LOAD DATA INFILE '/var/lib/mysql-files/notasCorte2020.csv' INTO TABLE NotasCorte2020 FIELDS TERMINATED BY ';' ENCLOSED BY'' LINES TERMINATED BY '\n' IGNORE 1 ROWS(CURSO_ACADEMICO, ESTUDIO, LOCALIDAD, CENTRO, PRELA_CONVO_NOTA_DEF, NOTA_CORTE_DEFINITIVA_JULIO, @NOTA_CORTE_DEFINITIVA_SEPTIEMBRE, FECHA_ACTUALIZACION) SET NOTA_CORTE_DEFINITIVA_SEPTIEMBRE = NULLIF(@NOTA_CORTE_DEFINITIVA_SEPTIEMBRE, '');"

MYSQL_PWD=${PASSWDDB} mysql -u administrador -D resultadosofertaacademica -e "CREATE TABLE NotasCorte2019(CURSO_ACADEMICO INT, ESTUDIO VARCHAR(100), LOCALIDAD VARCHAR(30), CENTRO VARCHAR(100), PRELA_CONVO_NOTA_DEF CHAR(2), NOTA_CORTE_DEFINITIVA_JULIO  FLOAT, NOTA_CORTE_DEFINITIVA_SEPTIEMBRE VARCHAR(30), FECHA_ACTUALIZACION VARCHAR(15));"
MYSQL_PWD=${PASSWDDB} mysql -u administrador -D resultadosofertaacademica -e "LOAD DATA INFILE '/var/lib/mysql-files/notasCorte2019.csv' INTO TABLE NotasCorte2019 FIELDS TERMINATED BY ';' ENCLOSED BY'' LINES TERMINATED BY '\n' IGNORE 1 ROWS(CURSO_ACADEMICO, ESTUDIO, LOCALIDAD, CENTRO, PRELA_CONVO_NOTA_DEF, NOTA_CORTE_DEFINITIVA_JULIO, @NOTA_CORTE_DEFINITIVA_SEPTIEMBRE, FECHA_ACTUALIZACION) SET NOTA_CORTE_DEFINITIVA_SEPTIEMBRE = NULLIF(@NOTA_CORTE_DEFINITIVA_SEPTIEMBRE, '');"

echo " Datos cargados exitosamente"

#Carga de datos de movilidad a la base de datos resultadosofertaacademica
MYSQL_PWD=${PASSWDDB} mysql -u administrador -D resultadosofertaacademica -e "CREATE TABLE movilidad2019(CURSO_ACADEMICO INT, NOMBRE_PROGRAMA_MOVILIDAD VARCHAR(8), NOMBRE_AREA_ESTUDIOS_MOV VARCHAR(100), CENTRO VARCHAR(100), IN_OUT VARCHAR(4), NOMBRE_IDIOMA_NIVEL_MOVILIDAD VARCHAR(40), PAIS_UNIVERSIDAD_ACUERDO VARCHAR(30), UNIVERSIDAD_ACUERDO VARCHAR(100), PLAZAS_OFERTADAS_ALUMNOS INT, PLAZAS_ASIGNADAS_ALUMNO_OUT TINYINT, FECHA_ACTUALIZACION VARCHAR(30));"
MYSQL_PWD=${PASSWDDB} mysql -u administrador -D resultadosofertaacademica -e "LOAD DATA INFILE '/var/lib/mysql-files/movilidad2019.csv' INTO TABLE movilidad2019 FIELDS TERMINATED BY ';' ENCLOSED BY'' LINES TERMINATED BY '\n' IGNORE 1 ROWS;"

MYSQL_PWD=${PASSWDDB} mysql -u administrador -D resultadosofertaacademica -e "CREATE TABLE movilidad2020(CURSO_ACADEMICO INT, NOMBRE_PROGRAMA_MOVILIDAD VARCHAR(8), NOMBRE_AREA_ESTUDIOS_MOV VARCHAR(100), CENTRO VARCHAR(100), IN_OUT VARCHAR(4), NOMBRE_IDIOMA_NIVEL_MOVILIDAD VARCHAR(40), PAIS_UNIVERSIDAD_ACUERDO VARCHAR(30), UNIVERSIDAD_ACUERDO VARCHAR(100), PLAZAS_OFERTADAS_ALUMNOS INT, PLAZAS_ASIGNADAS_ALUMNO_OUT TINYINT, FECHA_ACTUALIZACION VARCHAR(30));"
MYSQL_PWD=${PASSWDDB} mysql -u administrador -D resultadosofertaacademica -e "LOAD DATA INFILE '/var/lib/mysql-files/movilidad2020.csv' INTO TABLE movilidad2020 FIELDS TERMINATED BY ';' ENCLOSED BY'' LINES TERMINATED BY '\n' IGNORE 1 ROWS;"

MYSQL_PWD=${PASSWDDB} mysql -u administrador -D resultadosofertaacademica -e "CREATE TABLE movilidad2021(CURSO_ACADEMICO INT, NOMBRE_PROGRAMA_MOVILIDAD VARCHAR(8), NOMBRE_AREA_ESTUDIOS_MOV VARCHAR(100), CENTRO VARCHAR(100), IN_OUT VARCHAR(4), NOMBRE_IDIOMA_NIVEL_MOVILIDAD VARCHAR(40), PAIS_UNIVERSIDAD_ACUERDO VARCHAR(30), UNIVERSIDAD_ACUERDO VARCHAR(100), PLAZAS_OFERTADAS_ALUMNOS INT, PLAZAS_ASIGNADAS_ALUMNO_OUT TINYINT, FECHA_ACTUALIZACION VARCHAR(30));"
MYSQL_PWD=${PASSWDDB} mysql -u administrador -D resultadosofertaacademica -e "LOAD DATA INFILE '/var/lib/mysql-files/movilidad2021.csv' INTO TABLE movilidad2021 FIELDS TERMINATED BY ';' ENCLOSED BY'' LINES TERMINATED BY '\n' IGNORE 1 ROWS;"
...
MYSQL_PWD=${PASSWDDB} mysql -u administrador -D resultadosofertaacademica -e "CREATE TABLE Oferta_Ocupacion2019(CURSO_ACADEMICO INT, ESTUDIO VARCHAR(150), LOCALIDAD VARCHAR(30), CENTRO VARCHAR(100),TIPO_CENTRO VARCHAR(25), TIPO_ESTUDIO VARCHAR(15), PLAZAS INT, PLAZAS_MATRICULADAS INT, PLAZAS_SOLICITADAS INT, INDICE_OCUPACION FLOAT, FECHA_ACTUALIZACION VARCHAR(30));"
MYSQL_PWD=${PASSWDDB} mysql -u administrador -D resultadosofertaacademica -e "LOAD DATA INFILE '/var/lib/mysql-files/Oferta2019.csv' INTO TABLE Oferta_Ocupacion2019 FIELDS TERMINATED BY ';' ENCLOSED BY'' LINES TERMINATED BY '\n' IGNORE 1 ROWS;"

MYSQL_PWD=${PASSWDDB} mysql -u administrador -D resultadosofertaacademica -e "CREATE TABLE Oferta_Ocupacion2020(CURSO_ACADEMICO INT, ESTUDIO VARCHAR(150), LOCALIDAD VARCHAR(30), CENTRO VARCHAR(100),TIPO_CENTRO VARCHAR(25), TIPO_ESTUDIO VARCHAR(15), PLAZAS INT, PLAZAS_MATRICULADAS INT, PLAZAS_SOLICITADAS INT, INDICE_OCUPACION FLOAT, FECHA_ACTUALIZACION VARCHAR(30));"
MYSQL_PWD=${PASSWDDB} mysql -u administrador -D resultadosofertaacademica -e "LOAD DATA INFILE '/var/lib/mysql-files/Oferta2020.csv' INTO TABLE Oferta_Ocupacion2020 FIELDS TERMINATED BY ';' ENCLOSED BY'' LINES TERMINATED BY '\n' IGNORE 1 ROWS;"

MYSQL_PWD=${PASSWDDB} mysql -u administrador -D resultadosofertaacademica -e "CREATE TABLE Oferta_Ocupacion2021(CURSO_ACADEMICO INT, ESTUDIO VARCHAR(150), LOCALIDAD VARCHAR(30), CENTRO VARCHAR(100),TIPO_CENTRO VARCHAR(25), TIPO_ESTUDIO VARCHAR(15), PLAZAS INT, PLAZAS_MATRICULADAS INT, PLAZAS_SOLICITADAS INT, INDICE_OCUPACION FLOAT, FECHA_ACTUALIZACION VARCHAR(30));"
MYSQL_PWD=${PASSWDDB} mysql -u administrador -D resultadosofertaacademica -e "LOAD DATA INFILE '/var/lib/mysql-files/Oferta2021.csv' INTO TABLE Oferta_Ocupacion2021 FIELDS TERMINATED BY ';' ENCLOSED BY'' LINES TERMINATED BY '\n' IGNORE 1 ROWS;"
...
MYSQL_PWD=${PASSWDDB} mysql -u administrador -D resultadosofertaacademica -e "CREATE TABLE Resultados2020(CURSO_ACADEMICO INT,CENTRO VARCHAR(100), ESTUDIO VARCHAR(150),TIPO_ESTUDIO VARCHAR(50), ALUMNOS_MATRICULADOS INT, ALUMNOS_NUEVO_INGRESO INT, PLAZAS_OFERTADAS INT, ALUMNOS_GRADUADOS INT,ALUMNOS_ADAPTA_GRADO_MATRI INT, ALUMNOS_ADAPTA_GRADO_MATRI_NI INT, ALUMNOS_ADAPTA_GRADO_TITULADO INT, ALUMNOS_CON_RECONOCIMIENTO INT, ALUMNOS_MOVILIDAD_ENTRADA INT, ALUMNOS_MOVILIDAD_SALIDA INT, CREDITOS_MATRICULADOS FLOAT, CREDITOS_RECONOCIDOS FLOAT, DURACION_MEDIA_GRADUADOS FLOAT, TASA_EXITO FLOAT, TASA_RENDIMIENTO FLOAT, TASA_EFICIENCIA FLOAT, TASA_ABANDONO FLOAT, TASA_GRADUACION FLOAT, FECHA_ACTUALIZACION VARCHAR(30));"
MYSQL_PWD=${PASSWDDB} mysql -u administrador -D resultadosofertaacademica -e "LOAD DATA INFILE '/var/lib/mysql-files/Resultados2020.csv' INTO TABLE Resultados2020 FIELDS TERMINATED BY ';' ENCLOSED BY'' LINES TERMINATED BY '\n' IGNORE 1 ROWS(CURSO_ACADEMICO,CENTRO, ESTUDIO,TIPO_ESTUDIO, @ALUMNOS_MATRICULADOS, @ALUMNOS_NUEVO_INGRESO, @PLAZAS_OFERTADAS, @ALUMNOS_GRADUADOS,@ALUMNOS_ADAPTA_GRADO_MATRI, @ALUMNOS_ADAPTA_GRADO_MATRI_NI, @ALUMNOS_ADAPTA_GRADO_TITULADO, @ALUMNOS_CON_RECONOCIMIENTO, @ALUMNOS_MOVILIDAD_ENTRADA, @ALUMNOS_MOVILIDAD_SALIDA, @CREDITOS_MATRICULADOS, @CREDITOS_RECONOCIDOS, @DURACION_MEDIA_GRADUADOS, @TASA_EXITO, @TASA_RENDIMIENTO, @TASA_EFICIENCIA, @TASA_ABANDONO, @TASA_GRADUACION, FECHA_ACTUALIZACION) 
                                        SET ALUMNOS_NUEVO_INGRESO = NULLIF(@ALUMNOS_NUEVO_INGRESO,''), ALUMNOS_MATRICULADOS= NULLIF(@ALUMNOS_MATRICULADOS,''), ALUMNOS_NUEVO_INGRESO= NULLIF(@ALUMNOS_NUEVO_INGRESO,''), PLAZAS_OFERTADAS= NULLIF(@PLAZAS_OFERTADAS,''), ALUMNOS_GRADUADOS= NULLIF(@ALUMNOS_GRADUADOS,''),ALUMNOS_ADAPTA_GRADO_MATRI= NULLIF(@ALUMNOS_ADAPTA_GRADO_MATRI,''), ALUMNOS_ADAPTA_GRADO_MATRI_NI= NULLIF(@ALUMNOS_ADAPTA_GRADO_MATRI_NI,''), ALUMNOS_ADAPTA_GRADO_TITULADO= NULLIF(@ALUMNOS_ADAPTA_GRADO_TITULADO,''), ALUMNOS_CON_RECONOCIMIENTO= NULLIF(@ALUMNOS_CON_RECONOCIMIENTO,''), ALUMNOS_MOVILIDAD_ENTRADA= NULLIF(@ALUMNOS_MOVILIDAD_ENTRADA,''), ALUMNOS_MOVILIDAD_ENTRADA= NULLIF(@ALUMNOS_MOVILIDAD_SALIDA,''),
                                         CREDITOS_MATRICULADOS= NULLIF(@CREDITOS_MATRICULADOS,''), CREDITOS_RECONOCIDOS= NULLIF(@CREDITOS_RECONOCIDOS,''), DURACION_MEDIA_GRADUADOS= NULLIF(@DURACION_MEDIA_GRADUADOS,''), TASA_EXITO= NULLIF(@TASA_EXITO,''), TASA_RENDIMIENTO= NULLIF(@TASA_RENDIMIENTO,''), TASA_EFICIENCIA= NULLIF(@TASA_EFICIENCIA,''), TASA_ABANDONO= NULLIF(@TASA_ABANDONO,''), TASA_GRADUACION= NULLIF(@TASA_GRADUACION,'');"

MYSQL_PWD=${PASSWDDB} mysql -u administrador -D resultadosofertaacademica -e "CREATE TABLE Resultados2019(CURSO_ACADEMICO INT,CENTRO VARCHAR(100), ESTUDIO VARCHAR(150),TIPO_ESTUDIO VARCHAR(50), ALUMNOS_MATRICULADOS INT, ALUMNOS_NUEVO_INGRESO INT, PLAZAS_OFERTADAS INT, ALUMNOS_GRADUADOS INT,ALUMNOS_ADAPTA_GRADO_MATRI INT, ALUMNOS_ADAPTA_GRADO_MATRI_NI INT, ALUMNOS_ADAPTA_GRADO_TITULADO INT, ALUMNOS_CON_RECONOCIMIENTO INT, ALUMNOS_MOVILIDAD_ENTRADA INT, ALUMNOS_MOVILIDAD_SALIDA INT, CREDITOS_MATRICULADOS FLOAT, CREDITOS_RECONOCIDOS FLOAT, DURACION_MEDIA_GRADUADOS FLOAT, TASA_EXITO FLOAT, TASA_RENDIMIENTO FLOAT, TASA_EFICIENCIA FLOAT, TASA_ABANDONO FLOAT, TASA_GRADUACION FLOAT, FECHA_ACTUALIZACION VARCHAR(30));"
MYSQL_PWD=${PASSWDDB} mysql -u administrador -D resultadosofertaacademica -e "LOAD DATA INFILE '/var/lib/mysql-files/Resultados2019.csv' INTO TABLE Resultados2019 FIELDS TERMINATED BY ';' ENCLOSED BY'' LINES TERMINATED BY '\n' IGNORE 1 ROWS(CURSO_ACADEMICO,CENTRO, ESTUDIO,TIPO_ESTUDIO, @ALUMNOS_MATRICULADOS, @ALUMNOS_NUEVO_INGRESO, @PLAZAS_OFERTADAS, @ALUMNOS_GRADUADOS,@ALUMNOS_ADAPTA_GRADO_MATRI, @ALUMNOS_ADAPTA_GRADO_MATRI_NI, @ALUMNOS_ADAPTA_GRADO_TITULADO, @ALUMNOS_CON_RECONOCIMIENTO, @ALUMNOS_MOVILIDAD_ENTRADA, @ALUMNOS_MOVILIDAD_SALIDA, @CREDITOS_MATRICULADOS, @CREDITOS_RECONOCIDOS, @DURACION_MEDIA_GRADUADOS, @TASA_EXITO, @TASA_RENDIMIENTO, @TASA_EFICIENCIA, @TASA_ABANDONO, @TASA_GRADUACION, FECHA_ACTUALIZACION) 
                                        SET ALUMNOS_NUEVO_INGRESO = NULLIF(@ALUMNOS_NUEVO_INGRESO,''), ALUMNOS_MATRICULADOS= NULLIF(@ALUMNOS_MATRICULADOS,''), ALUMNOS_NUEVO_INGRESO= NULLIF(@ALUMNOS_NUEVO_INGRESO,''), PLAZAS_OFERTADAS= NULLIF(@PLAZAS_OFERTADAS,''), ALUMNOS_GRADUADOS= NULLIF(@ALUMNOS_GRADUADOS,''),ALUMNOS_ADAPTA_GRADO_MATRI= NULLIF(@ALUMNOS_ADAPTA_GRADO_MATRI,''), ALUMNOS_ADAPTA_GRADO_MATRI_NI= NULLIF(@ALUMNOS_ADAPTA_GRADO_MATRI_NI,''), ALUMNOS_ADAPTA_GRADO_TITULADO= NULLIF(@ALUMNOS_ADAPTA_GRADO_TITULADO,''), ALUMNOS_CON_RECONOCIMIENTO= NULLIF(@ALUMNOS_CON_RECONOCIMIENTO,''), ALUMNOS_MOVILIDAD_ENTRADA= NULLIF(@ALUMNOS_MOVILIDAD_ENTRADA,''), ALUMNOS_MOVILIDAD_ENTRADA= NULLIF(@ALUMNOS_MOVILIDAD_SALIDA,''),
                                         CREDITOS_MATRICULADOS= NULLIF(@CREDITOS_MATRICULADOS,''), CREDITOS_RECONOCIDOS= NULLIF(@CREDITOS_RECONOCIDOS,''), DURACION_MEDIA_GRADUADOS= NULLIF(@DURACION_MEDIA_GRADUADOS,''), TASA_EXITO= NULLIF(@TASA_EXITO,''), TASA_RENDIMIENTO= NULLIF(@TASA_RENDIMIENTO,''), TASA_EFICIENCIA= NULLIF(@TASA_EFICIENCIA,''), TASA_ABANDONO= NULLIF(@TASA_ABANDONO,''), TASA_GRADUACION= NULLIF(@TASA_GRADUACION,'');"
...
MYSQL_PWD=${PASSWDDB} mysql -u administrador -D resultadosofertaacademica -e "CREATE TABLE Egresados2020(CURSO_ACADEMICO INT,LOCALIDAD VARCHAR(100), ESTUDIO VARCHAR(150),TIPO_ESTUDIO VARCHAR(50), TIPO_EGRESO VARCHAR(70), SEXO VARCHAR(15), ALUMNOS_GRADUADOS INT, ALUMNOS_INTERRUMPEN_ESTUDIOS INT, ALUMNOS_INTERRUMPEN_EST_ANO1 INT, ALUMNOS_TRASLADAN_OTRA_UNIV INT , DURACION_mEDIA_GRADUADOS FLOAT, TASA_EFIENCIA FLOAT, FECHA_ACTUALIZACION VARCHAR(30));"
MYSQL_PWD=${PASSWDDB} mysql -u administrador -D resultadosofertaacademica -e "LOAD DATA INFILE '/var/lib/mysql-files/Egresados2020.csv' INTO TABLE Egresados2020 FIELDS TERMINATED BY ';' ENCLOSED BY'' LINES TERMINATED BY '\n' IGNORE 1 ROWS(CURSO_ACADEMICO,LOCALIDAD, ESTUDIO,TIPO_ESTUDIO, TIPO_EGRESO, SEXO, @ALUMNOS_GRADUADOS, @ALUMNOS_INTERRUMPEN_ESTUDIOS, @ALUMNOS_INTERRUMPEN_EST_ANO1, @ALUMNOS_TRASLADAN_OTRA_UNIV, @DURACION_mEDIA_GRADUADOS, @TASA_EFIENCIA, FECHA_ACTUALIZACION)SET 
                                        ALUMNOS_GRADUADOS= NULLIF(@ALUMNOS_GRADUADOS,''),ALUMNOS_INTERRUMPEN_ESTUDIOS= NULLIF(@ALUMNOS_INTERRUMPEN_ESTUDIOS,''),ALUMNOS_INTERRUMPEN_EST_ANO1= NULLIF(@ALUMNOS_INTERRUMPEN_EST_ANO1,''),ALUMNOS_TRASLADAN_OTRA_UNIV= NULLIF(@ALUMNOS_TRASLADAN_OTRA_UNIV,''),DURACION_mEDIA_GRADUADOS= NULLIF(@DURACION_mEDIA_GRADUADOS,''),TASA_EFIENCIA= NULLIF(@TASA_EFIENCIA,'');"

MYSQL_PWD=${PASSWDDB} mysql -u administrador -D resultadosofertaacademica -e "CREATE TABLE Egresados2021(CURSO_ACADEMICO INT,LOCALIDAD VARCHAR(100), ESTUDIO VARCHAR(150),TIPO_ESTUDIO VARCHAR(50), TIPO_EGRESO VARCHAR(70), SEXO VARCHAR(15), ALUMNOS_GRADUADOS INT, ALUMNOS_INTERRUMPEN_ESTUDIOS INT, ALUMNOS_INTERRUMPEN_EST_ANO1 INT, ALUMNOS_TRASLADAN_OTRA_UNIV INT , DURACION_mEDIA_GRADUADOS FLOAT, TASA_EFIENCIA FLOAT, FECHA_ACTUALIZACION VARCHAR(30));"
MYSQL_PWD=${PASSWDDB} mysql -u administrador -D resultadosofertaacademica -e "LOAD DATA INFILE '/var/lib/mysql-files/Egresados2021.csv' INTO TABLE Egresados2021 FIELDS TERMINATED BY ';' ENCLOSED BY'' LINES TERMINATED BY '\n' IGNORE 1 ROWS(CURSO_ACADEMICO,LOCALIDAD, ESTUDIO,TIPO_ESTUDIO, TIPO_EGRESO, SEXO, @ALUMNOS_GRADUADOS, @ALUMNOS_INTERRUMPEN_ESTUDIOS, @ALUMNOS_INTERRUMPEN_EST_ANO1, @ALUMNOS_TRASLADAN_OTRA_UNIV, @DURACION_mEDIA_GRADUADOS, @TASA_EFIENCIA, FECHA_ACTUALIZACION)SET 
                                        ALUMNOS_GRADUADOS= NULLIF(@ALUMNOS_GRADUADOS,''),ALUMNOS_INTERRUMPEN_ESTUDIOS= NULLIF(@ALUMNOS_INTERRUMPEN_ESTUDIOS,''),ALUMNOS_INTERRUMPEN_EST_ANO1= NULLIF(@ALUMNOS_INTERRUMPEN_EST_ANO1,''),ALUMNOS_TRASLADAN_OTRA_UNIV= NULLIF(@ALUMNOS_TRASLADAN_OTRA_UNIV,''),DURACION_mEDIA_GRADUADOS= NULLIF(@DURACION_mEDIA_GRADUADOS,''),TASA_EFIENCIA= NULLIF(@TASA_EFIENCIA,'');"


MYSQL_PWD=${PASSWDDB} mysql -u administrador -D resultadosofertaacademica -e "
...
MYSQL_PWD=${PASSWDDB} mysql -u administrador -D resultadosofertaacademica -e " INSERT INTO Localidad (nombre_localidad) SELECT distinct LOCALIDAD FROM Oferta_Ocupacion2021; "
echo " Cargando datos en la tabla pais "
MYSQL_PWD=${PASSWDDB} mysql -u administrador -D resultadosofertaacademica -e " INSERT INTO Pais (nombre_pais) SELECT distinct PAIS_UNIVERSIDAD_ACUERDO FROM movilidad2021;"
echo " Cargando datos en la tabla Movilidad "
MYSQL_PWD=${PASSWDDB} mysql -u administrador -D resultadosofertaacademica -e " INSERT INTO Movilidad (nombre_movilidad) SELECT distinct NOMBRE_PROGRAMA_MOVILIDAD FROM movilidad2021;"
echo " Cargando datos en la tabla Centro "
MYSQL_PWD=${PASSWDDB} mysql -u administrador -D resultadosofertaacademica -e "INSERT INTO Centro(nombre_centro, tipo_centro, nombre_localidad) SELECT distinct CENTRO, TIPO_CENTRO, LOCALIDAD FROM Oferta_Ocupacion2021;"
...
MYSQL_PWD=${PASSWDDB} mysql -u administrador -D resultadosofertaacademica -e "CREATE TABLE temporalB(CURSO_ACADEMICO VARCHAR (15), estudio VARCHAR(150), localidad VARCHAR(100), Centro VARCHAR(100), abandonos INT);"

MYSQL_PWD=${PASSWDDB} mysql -u administrador -D resultadosofertaacademica -e "INSERT INTO temporalB (estudio, localidad, Centro, abandonos, CURSO_ACADEMICO)
...
MYSQL_PWD=${PASSWDDB} mysql -u administrador -D resultadosofertaacademica -e "INSERT INTO Impartido  (curso, nombre_estudio, nombre_centro, plazas_matriculadas,alumnos_nuevo_ingreso, 
