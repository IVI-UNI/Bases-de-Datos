...
wget -q -O $HOME/Practica1/Retaos2019.csv 'https://zaguan.unizar.es/record/76879/files/CSV.csv'
#Carga de datos resltados a la base de datos temporal
echo "Cargando datos a la base de datos..."
psql -U postgres  temporal -c "CREATE TABLE ResultadosTitulaciones2021(CURSO_ACADEMICO SMALLINT,CENTRO VARCHAR(100), ESTUDIO VARCHAR(150),TIPO_ESTUDIO VARCHAR(15), ALUMNOS_MATRICULADOS SMALLINT, ALUMNOS_NUEVO_INGRESO SMALLINT, PLAZAS_OFERTADAS SMALLINT, ALUMNOS_GRADUADOS INT, INDICE_OCUPACION FLOAT, FECHA_ACTUALIZACION DATE);"
psql -U postgres temporal -c "COPY Oferta_Ocupacion2021 FROM '$HOME/Practica1/Oferta2021.csv' DELIMITER ';'CSV HEADER;"
psql -U postgres  temporal -c "CREATE TABLE ResultadosTitulaciones2020(CURSO_ACADEMICO SMALLINT,CENTRO VARCHAR(100), ESTUDIO VARCHAR(150),TIPO_ESTUDIO VARCHAR(15), ALUMNOS_MATRICULADOS SMALLINT, ALUMNOS_NUEVO_INGRESO SMALLINT, PLAZAS_OFERTADAS SMALLINT, ALUMNOS_GRADUADOS INT, INDICE_OCUPACION FLOAT, FECHA_ACTUALIZACION DATE);"
psql -U postgres temporal -c "COPY Oferta_Ocupacion2020 FROM '$HOME/Practica1/Oferta2020.csv' DELIMITER ';'CSV HEADER;"
psql -U postgres  temporal -c "CREATE TABLE ResultadosTitulaciones2019(CURSO_ACADEMICO SMALLINT,CENTRO VARCHAR(100), ESTUDIO VARCHAR(150),TIPO_ESTUDIO VARCHAR(15), ALUMNOS_MATRICULADOS SMALLINT, ALUMNOS_NUEVO_INGRESO SMALLINT, PLAZAS_OFERTADAS SMALLINT, ALUMNOS_GRADUADOS INT, INDICE_OCUPACION FLOAT, FECHA_ACTUALIZACION DATE);"
psql -U postgres temporal -c "COPY Oferta_Ocupacion2019 FROM '$HOME/Practica1/Oferta2019.csv' DELIMITER ';'CSV HEADER;"

#Obtención de datos de  de los últimos 3 años
wget -q -O $HOME/Practica1/Resultados2021.csv 'https://zaguan.unizar.es/record/107371/files/CSV.csv'
wget -q -O $HOME/Practica1/Resultados2020.csv 'https://zaguan.unizar.es/record/98173/files/CSV.csv'
wget -q -O $HOME/Practica1/Resultados2019.csv 'https://zaguan.unizar.es/record/76879/files/CSV.csv'
#Carga de datos resltados a la base de datos temporal
echo "Cargando datos a la base de datos..."
psql -U postgres  temporal -c "CREATE TABLE ResultadosTitulaciones2021(CURSO_ACADEMICO SMALLINT,LOCALIDAD VARCHAR(100), ESTUDIO VARCHAR(150),TIPO_ESTUDIO VARCHAR(15), TIPO_EGRESO VARCHAR(70), SEXO VARCHAR(10), ALUMNOS_GRADUADOS SMALLINT, ALUMNOS_INTERRUMPEN_STUDIOS INT, ALUMNOS_INTERRUMPEN_EST_ANO1 INT, ALUMNOS_TRASLADAN_OTRA_UNIV INT , DURACION_mEDIA_GRADUADOS INT, TASA_EFIENCIA FLOAT, FECHA_ACTUALIZACION DATE);"
psql -U postgres temporal -c "COPY RsTtul2021 FROM '$HOME/Practica1/Oferta2021.csv' DELIMITER ';'CSV HEADER;"
