...
echo "Carpeta con los archivos CSV: /etc/postgresql/Practica1"
...
psql -U postgres -c"CREATE USER administrador SUPERUSER;"
psql -U postgres -c"ALTER USER administrador WITH PASSWORD '$contrasena'"
psql -U postgres -c "DROP DATABASE IF EXISTS resultadosofertaacademica;"

createdb resultadosofertaacademica;
psql -U postgres -c "GRANT ALL PRIVILEGES ON DATABASE resultadosofertaacademica to administrador;"

echo "Crear tablas de notasdeCorte"
...
psql -U administrador resultadosofertaacademica -c "CREATE TABLE NotasCorte2019(CURSO_ACADEMICO SMALLINT, ESTUDIO VARCHAR(100), LOCALIDAD VARCHAR(30), CENTRO VARCHAR(100), PRELA_CONVO_NOTA_DEF CHAR(2), NOTA_CORTE_DEFINITIVA_JULIO  float(3), NOTA_CORTE_DEFINITIVA_SEPTIEMBRE float(3), FECHA_ACTUALIZACION DATE);"
psql -U administrador resultadosofertaacademica -c "COPY NotasCorte2019 FROM '/etc/postgresql/Practica1/notasCorte2019.csv' DELIMITER ';'CSV HEADER;"

psql -U administrador resultadosofertaacademica -c "CREATE TABLE NotasCorte2020(CURSO_ACADEMICO SMALLINT, ESTUDIO VARCHAR(100), LOCALIDAD VARCHAR(30), CENTRO VARCHAR(100), PRELA_CONVO_NOTA_DEF CHAR(2), NOTA_CORTE_DEFINITIVA_JULIO  float(3), NOTA_CORTE_DEFINITIVA_SEPTIEMBRE float(3), FECHA_ACTUALIZACION DATE);"
psql -U administrador resultadosofertaacademica -c "COPY NotasCorte2020 FROM '/etc/postgresql/Practica1/notasCorte2020.csv' DELIMITER ';'CSV HEADER;"

psql -U administrador resultadosofertaacademica -c "CREATE TABLE NotasCorte2021(CURSO_ACADEMICO SMALLINT, ESTUDIO VARCHAR(100), LOCALIDAD VARCHAR(30), CENTRO VARCHAR(100), PRELA_CONVO_NOTA_DEF CHAR(2), NOTA_CORTE_DEFINITIVA_JULIO  float(3), NOTA_CORTE_DEFINITIVA_SEPTIEMBRE float(3), FECHA_ACTUALIZACION DATE);"
psql -U administrador resultadosofertaacademica -c "COPY NotasCorte2021 FROM '/etc/postgresql/Practica1/notasCorte2021.csv' DELIMITER ';'CSV HEADER;"

echo " Datos cargados exitosamente"


#Carga de datos de movilidad a la base de datos resultadosofertaacademica
psql -U administrador resultadosofertaacademica -c "CREATE TABLE movilidad2019(CURSO_ACADEMICO SMALLINT, NOMBRE_PROGRAMA_MOVILIDAD VARCHAR(8), NOMBRE_AREA_ESTUDIOS_MOV VARCHAR, CENTRO VARCHAR(100), IN_OUT VARCHAR(4), NOMBRE_IDIOMA_NIVEL_MOVILIDAD VARCHAR(40), PAIS_UNIVERSIDAD_ACUERDO VARCHAR(30), UNIVERSIDAD_ACUERDO VARCHAR, PLAZAS_OFERTADAS_ALUMNOS INT, PLAZAS_ASIGNADAS_ALUMNO_OUT SMALLINT, FECHA_ACTUALIZACION DATE);"
psql -U administrador resultadosofertaacademica -c "COPY movilidad2019 FROM '/etc/postgresql/Practica1/movilidad2019.csv' DELIMITER ';' CSV HEADER;"

psql -U administrador resultadosofertaacademica -c "CREATE TABLE movilidad2020(CURSO_ACADEMICO SMALLINT, NOMBRE_PROGRAMA_MOVILIDAD VARCHAR(8), NOMBRE_AREA_ESTUDIOS_MOV VARCHAR, CENTRO VARCHAR(100), IN_OUT VARCHAR(4), NOMBRE_IDIOMA_NIVEL_MOVILIDAD VARCHAR(40), PAIS_UNIVERSIDAD_ACUERDO VARCHAR(30), UNIVERSIDAD_ACUERDO VARCHAR, PLAZAS_OFERTADAS_ALUMNOS INT, PLAZAS_ASIGNADAS_ALUMNO_OUT SMALLINT, FECHA_ACTUALIZACION DATE);"
psql -U administrador resultadosofertaacademica -c "COPY movilidad2020 FROM '/etc/postgresql/Practica1/movilidad2020.csv' DELIMITER ';' CSV HEADER;"

psql -U administrador resultadosofertaacademica -c "CREATE TABLE movilidad2021(CURSO_ACADEMICO SMALLINT, NOMBRE_PROGRAMA_MOVILIDAD VARCHAR(8), NOMBRE_AREA_ESTUDIOS_MOV VARCHAR, CENTRO VARCHAR(100), IN_OUT VARCHAR(4), NOMBRE_IDIOMA_NIVEL_MOVILIDAD VARCHAR(40), PAIS_UNIVERSIDAD_ACUERDO VARCHAR(30), UNIVERSIDAD_ACUERDO VARCHAR, PLAZAS_OFERTADAS_ALUMNOS INT, PLAZAS_ASIGNADAS_ALUMNO_OUT SMALLINT, FECHA_ACTUALIZACION DATE);"
psql -U administrador resultadosofertaacademica -c "COPY movilidad2021 FROM '/etc/postgresql/Practica1/movilidad2021.csv' DELIMITER ';' CSV HEADER;"
...
psql -U administrador resultadosofertaacademica -c "COPY Oferta_Ocupacion2019 FROM '/etc/postgresql/Practica1/Oferta2019.csv' DELIMITER ';'CSV HEADER;"
...
psql -U administrador resultadosofertaacademica -c "COPY Oferta_Ocupacion2020 FROM '/etc/postgresql/Practica1/Oferta2020.csv' DELIMITER ';'CSV HEADER;"

psql -U administrador  resultadosofertaacademica -c "CREATE TABLE Oferta_Ocupacion2021(CURSO_ACADEMICO SMALLINT, ESTUDIO VARCHAR(150), LOCALIDAD VARCHAR(30), CENTRO VARCHAR(100),TIPO_CENTRO VARCHAR(25), TIPO_ESTUDIO VARCHAR(15), PLAZAS SMALLINT, PLAZAS_MATRICULADAS SMALLINT, PLAZAS_SOLICITADAS INT, INDICE_OCUPACION FLOAT, FECHA_ACTUALIZACION DATE);"
psql -U administrador resultadosofertaacademica -c "COPY Oferta_Ocupacion2021 FROM '/etc/postgresql/Practica1/Oferta2021.csv' DELIMITER ';'CSV HEADER;"
...
psql -U administrador resultadosofertaacademica -c "COPY Resultados2021 FROM '/etc/postgresql/Practica1/Resultados2021.csv' DELIMITER ';'CSV HEADER;"
...
psql -U administrador resultadosofertaacademica -c "COPY Resultados2020 FROM '/etc/postgresql/Practica1/Resultados2020.csv' DELIMITER ';'CSV HEADER;"
...
psql -U administrador resultadosofertaacademica -c "COPY Resultados2019 FROM '/etc/postgresql/Practica1/Resultados2019.csv' DELIMITER ';'CSV HEADER;"


#Carga de datos resltados a la base de datos resultadosofertaacademica
echo "Cargando datos a la base de datos..."
psql -U administrador  resultadosofertaacademica -c "CREATE TABLE Egresados2021(CURSO_ACADEMICO SMALLINT,LOCALIDAD VARCHAR(100), ESTUDIO VARCHAR(150),TIPO_ESTUDIO VARCHAR(50), TIPO_EGRESO VARCHAR(70), SEXO VARCHAR(20), ALUMNOS_GRADUADOS SMALLINT, ALUMNOS_INTERRUMPEN_ESTUDIOS INT, ALUMNOS_INTERRUMPEN_EST_ANO1 INT, ALUMNOS_TRASLADAN_OTRA_UNIV INT , DURACION_mEDIA_GRADUADOS FLOAT, TASA_EFIENCIA FLOAT, FECHA_ACTUALIZACION DATE);"
psql -U administrador resultadosofertaacademica -c "COPY Egresados2021 FROM '/etc/postgresql/Practica1/Egresados2019.csv' DELIMITER ';'CSV HEADER;"

psql -U administrador  resultadosofertaacademica -c "CREATE TABLE Egresados2020(CURSO_ACADEMICO SMALLINT,LOCALIDAD VARCHAR(100), ESTUDIO VARCHAR(150),TIPO_ESTUDIO VARCHAR(50), TIPO_EGRESO VARCHAR(70), SEXO VARCHAR(20), ALUMNOS_GRADUADOS SMALLINT, ALUMNOS_INTERRUMPEN_ESTUDIOS INT, ALUMNOS_INTERRUMPEN_EST_ANO1 INT, ALUMNOS_TRASLADAN_OTRA_UNIV INT , DURACION_mEDIA_GRADUADOS FLOAT, TASA_EFIENCIA FLOAT, FECHA_ACTUALIZACION DATE);"
psql -U administrador resultadosofertaacademica -c "COPY Egresados2020 FROM '/etc/postgresql/Practica1/Egresados2020.csv' DELIMITER ';'CSV HEADER;"

psql -U administrador  resultadosofertaacademica -c "CREATE TABLE Egresados2019(CURSO_ACADEMICO SMALLINT,LOCALIDAD VARCHAR(100), ESTUDIO VARCHAR(150),TIPO_ESTUDIO VARCHAR(50), TIPO_EGRESO VARCHAR(70), SEXO VARCHAR(20), ALUMNOS_GRADUADOS SMALLINT, ALUMNOS_INTERRUMPEN_ESTUDIOS INT, ALUMNOS_INTERRUMPEN_EST_ANO1 INT, ALUMNOS_TRASLADAN_OTRA_UNIV INT , DURACION_mEDIA_GRADUADOS FLOAT, TASA_EFIENCIA FLOAT, FECHA_ACTUALIZACION DATE);"
psql -U administrador resultadosofertaacademica -c "COPY Egresados2019 FROM '/etc/postgresql/Practica1/Egresados2021.csv' DELIMITER ';'CSV HEADER;"


psql -U administrador resultadosofertaacademica -c "CREATE TABLE Estudio (
    nombre_estudio varchar(100) NULL,
    PRIMARY KEY(nombre_estudio)
);"

echo "Cargando datos en la tabla ESTUDIO"
psql -U administrador resultadosofertaacademica -c "INSERT INTO estudio(nombre_estudio) SELECT distinct ESTUDIO FROM oferta_ocupacion2021;"
psql -U administrador resultadosofertaacademica -c "INSERT INTO estudio(nombre_estudio) SELECT distinct ESTUDIO FROM oferta_ocupacion2020 WHERE ESTUDIO NOT IN(SELECT nombre_estudio FROM ESTUDIO);"
psql -U administrador resultadosofertaacademica -c "INSERT INTO estudio(nombre_estudio) SELECT distinct ESTUDIO FROM oferta_ocupacion2019 WHERE ESTUDIO NOT IN(SELECT nombre_estudio FROM ESTUDIO);"
echo "Datos cargados en la tabla ESTUDIO"
echo "\n"

psql -U administrador resultadosofertaacademica -c "CREATE TABLE Centro (
    nombre_centro varchar(100) NULL,
    tipo_centro varchar(50) NULL,
    localidad varchar(50) NULL,
    PRIMARY KEY(nombre_centro)
);"
psql -U administrador resultadosofertaacademica -c "INSERT INTO Centro(nombre_centro, tipo_centro, localidad) SELECT distinct CENTRO, TIPO_CENTRO, LOCALIDAD FROM oferta_ocupacion2021;"

psql -U administrador resultadosofertaacademica -c "CREATE TABLE Impartido (
    id_impartido SERIAL,
    curso smallint,
...
psql -U administrador resultadosofertaacademica -c " WITH temporal(localidad, estudio, abandonos) AS(
...
psql -U administrador resultadosofertaacademica -c " CREATE TABLE Localidad (
    nombre_localidad varchar(100),
    PRIMARY KEY(nombre_localidad) 
);"
echo "Cargando datos en la tabla LOCALIDAD"
psql -U administrador resultadosofertaacademica -c "INSERT INTO Localidad (nombre_localidad) SELECT distinct Localidad FROM oferta_ocupacion2021;"
echo "Datos cargados en la tabla LOCALIDAD"
echo "\n"

psql -U administrador resultadosofertaacademica -c " CREATE TABLE Pais (
    nombre_pais varchar(100),
    PRIMARY KEY(nombre_pais) 
);"

echo "Cargando datos en la tabla PAIS" 
psql -U administrador resultadosofertaacademica -c "INSERT INTO Pais (nombre_pais) SELECT distinct PAIS_UNIVERSIDAD_ACUERDO FROM Movilidad2021;"
echo "Datos cargados en la tabla PAIS"
echo "\n"

psql -U administrador resultadosofertaacademica -c " CREATE TABLE Movilidad (
    nombre_movilidad varchar(50),
    PRIMARY KEY(nombre_movilidad)
);"
echo "Cargando datos en la tabla MOVILIDAD" 
psql -U administrador resultadosofertaacademica -c "INSERT INTO Movilidad (nombre_movilidad) SELECT distinct NOMBRE_PROGRAMA_MOVILIDAD FROM Movilidad2021;"
echo "Datos cargados en la tabla MOVILIDAD"
echo "\n"

psql -U administrador resultadosofertaacademica -c " CREATE TABLE Realiza (
    id_realizar SERIAL,
    curso smallint,
...
psql -U administrador resultadosofertaacademica -c "INSERT INTO Realiza (curso, nombre_movilidad, nombre_centro, nombre_pais, area_estudios,
...
psql -U administrador resultadosofertaacademica -c "DROP TABLE notasCorte2019;"
psql -U administrador resultadosofertaacademica -c "DROP TABLE notasCorte2020;"
psql -U administrador resultadosofertaacademica -c "DROP TABLE notasCorte2021;"
#Elminar las tablas Resultados de las titulaciones
psql -U administrador resultadosofertaacademica -c "DROP TABLE Resultados2019;"
psql -U administrador resultadosofertaacademica -c "DROP TABLE Resultados2020;"
psql -U administrador resultadosofertaacademica -c "DROP TABLE Resultados2021;"
#Elminar las tablas de Movilidad de estudiantes
psql -U administrador resultadosofertaacademica -c "DROP TABLE Movilidad2019;"
psql -U administrador resultadosofertaacademica -c "DROP TABLE Movilidad2020;"
psql -U administrador resultadosofertaacademica -c "DROP TABLE Movilidad2021;"
#Eliminar las tablas de egresados
psql -U administrador resultadosofertaacademica -c "DROP TABLE Egresados2019;"
psql -U administrador resultadosofertaacademica -c "DROP TABLE Egresados2020;"
psql -U administrador resultadosofertaacademica -c "DROP TABLE Egresados2021;"
#elminar las tablas de oferta y ocupacion
psql -U administrador resultadosofertaacademica -c "DROP TABLE oferta_ocupacion2019;"
psql -U administrador resultadosofertaacademica -c "DROP TABLE oferta_ocupacion2020;"
psql -U administrador resultadosofertaacademica -c "DROP TABLE oferta_ocupacion2021;"

psql -U administrador resultadosofertaacademica -c "CREATE TABLE filas_modificadas (
...
psql -U administrador resultadosofertaacademica -c "CREATE OR REPLACE FUNCTION cambio_tabla_impartido() RETURNS TRIGGER
                                    AS $\$
 ...
 psql -U administrador resultadosofertaacademica -c " CREATE TRIGGER registrar_operaciones 
                                        AFTER UPDATE OR DELETE 
                                        ON Impartido
                                        FOR EACH ROW
                                        EXECUTE FUNCTION cambio_tabla_impartido();"
psql -U administrador resultadosofertaacademica -c " CREATE USER profesor WITH ENCRYPTED PASSWORD 'lol';"
psql -U administrador resultadosofertaacademica -c "  GRANT CONNECT ON DATABASE resultadosofertaacademica TO profesor;"
psql -U administrador resultadosofertaacademica -c " GRANT SELECT ON ALL TABLES IN SCHEMA public TO profesor;"
